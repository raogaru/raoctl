...
f_group_create () {
INPUT
${EMCLI} create_group -name="${input1}"
}
# ------------------------------------------------------------
f_group_delete () {
INPUT
${EMCLI} delete_group -name="${input1}"
}
# ------------------------------------------------------------
f_group_list () {
${EMCLI} get_groups -format="name:pretty" 
}
# ------------------------------------------------------------
f_group_list_csv () {
${EMCLI} get_groups -format="name:csv" 
}
# ------------------------------------------------------------
f_group_list_script () {
${EMCLI} get_groups -format="name:script" 
}
# ------------------------------------------------------------
f_group_export () {
...
f_group_modify_type () {
INPUT 2
${EMCLI} modify_group -name="${input1}" -type="${input2}"
}
# ------------------------------------------------------------
f_group_add_target () {
INPUT 3
${EMCLI} modify_group -name="${input1}" -add_targets="${input2}:${input3}"
}
# ------------------------------------------------------------
f_group_delete_target () {
INPUT 3
${EMCLI} modify_group -name="${input1}" -delete_targets="${input2}:${input3}"
}
# ------------------------------------------------------------
f_group_enable_priv_prop () {
INPUT
${EMCLI} -name="${input1}" -privilege_propagation=true
}
# ------------------------------------------------------------
f_group_disable_priv_prop () {
INPUT
${EMCLI} -name="${input1}" -privilege_propagation=false
}
# ------------------------------------------------------------
f_group_drop_existing_grants () {
INPUT
${EMCLI} -name="${input1}" -drop_existing_grants=yes
}
# ------------------------------------------------------------
f_group_list_members () {
INPUT
${EMCLI} get_group_members -name="${input1}" -format="name:pretty"
}
# ------------------------------------------------------------
f_group_list_members_csv () {
INPUT
${EMCLI} get_group_members -name="${input1}" -format="name:csv"
}
# ------------------------------------------------------------
f_group_list_members_script () {
INPUT
${EMCLI} get_group_members -name="${input1}" -format="name:script"
}
# ------------------------------------------------------------
